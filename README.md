...
This cheatsheet is a curated collection of tools, resources, and references for Open Source Intelligence (OSINT) investigations. It is intended to serve as a quick reference guide for researchers, analysts, and security professionals who need to gather, verify, and analyze publicly available information. All resources listed here are publicly accessible and organized by category to streamline the investigation process.
